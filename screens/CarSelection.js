  ...
  return <View style={styles.container}>
    ...
    <View style={{ flexDirection: 'row' }} >
      <Text onPress={() => {
        setCarType('Bike')
        setFare(distance * 70)
      }} style={styles.rides}>Bike<Image source={{ uri: 'https://imgd.aeplcdn.com/370x208/n/cw/ec/43482/sp-125-right-front-three-quarter-2.jpeg?isig=0&q=80' }} style={{ width: 30, height: 30 }} /></Text>
      <Text onPress={() => {
        setCarType('Rickshaw')
        setFare(distance * 150)
      }} style={styles.rides}>Rickshaw<Image source={{ uri: 'https://i.tribune.com.pk/media/images/1671727-m-1522296266/1671727-m-1522296266.jpg' }} style={{ width: 30, height: 30 }} /></Text>
      <Text onPress={() => {
        setCarType('Car Mini')
        setFare(distance * 200)
      }} style={styles.rides}>Economy<Image source={{ uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRCOWAs52sBj48QFhCt2t6HJKxxNJ29d28sdg&usqp=CAU' }} style={{ width: 30, height: 30 }} /></Text>
      <Text onPress={() => {
        setCarType('Car AC')
        setFare(distance * 350)
      }} style={styles.rides}>Comfort  <Image source={{ uri: 'https://cache1.pakwheels.com/system/car_generation_pictures/6425/original/Honda_City_Front.jpg?1651424945' }} style={{ width: 30, height: 30 }} /></Text>
    </View>
